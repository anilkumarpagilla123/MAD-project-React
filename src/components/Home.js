  ...
  return (
    <Container className="text-center mt-2 mb-5">
      ...
      <div className="child row1 card mt-4 d-block mx-auto shadow-lg mb-5">
        <div className="row">
          <div className="col-md-4">
            <img src={logoImg2} className="w-100" alt="" />
          </div>
          <div className="col-md-8 mt-4">
            <p className="lead">
              Charitable organization is a kind of institution or a business
              that falls under the category of NPO or non-profit
              organization.This type of organization is often called a
              foundation or charity. It can be based on educational, religious
              or even based on public interest activities. A charity is
              something which is gifted or donated to an organization or an
              individual to help them or to benefit them.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <p>
          You can create change that lasts a lifetime for children in India – in
          so many ways.
        </p>
      </div>
      ...
      <div className="container-fluid d-flex justify-content-around mt-4">
        <Card className="child shadow-lg" style={{ width: "20rem" }}>
          ...
          <Card.Body>
            <Card.Text>
              Support the India COVID-19 Crisis Children's Relief Fund today to
              help the millions of at-risk children and families in India
              through this crisis.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="child shadow-lg" style={{ width: "20rem" }}>
          ...
          <Card.Body>
            <Card.Text>
              Be the hero in the life of a child. Sponsorship drives lasting
              change in children’s lives, families and communities.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        <Card className="child shadow-lg" style={{ width: "20rem" }}>
          ...
          <Card.Body>
            <Card.Text>
              Give a meaningful gift that will help transform children’s lives
              and futures in India and beyond. There’s something for everyone!
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
